( function () {
	...
	class TransformControlsGizmo extends THREE.Object3D {
		...
		constructor() {
			...
			const lineGeometry2 = new THREE.CylinderGeometry( 0.01, 0.01, 0.3, 3 );
			lineGeometry2.translate( 0, 0.35, 0 );
  ...
  XYZ: [
    [ new THREE.Mesh( new THREE.BoxGeometry( 0.1, 0.1, 0.1 ), matInvisible.clone() ), [ 0, 0, 0 ]]
  ],
  XY: [
    [ new THREE.Mesh( new THREE.BoxGeometry( 0.15, 0.15, 0.01 ), matBlueTransparent.clone() ), [ 0.2, 0.2, 0 ]]
  ],
  YZ: [
    [ new THREE.Mesh( new THREE.BoxGeometry( 0.15, 0.15, 0.01 ), matRedTransparent.clone() ), [ 0, 0.2, 0.2 ], [ 0, Math.PI / 2, 0 ]]
  ],
  XZ: [
    [ new THREE.Mesh( new THREE.BoxGeometry( 0.15, 0.15, 0.01 ), matGreenTransparent.clone() ), [ 0.2, 0, 0.2 ], [ - Math.PI / 2, 0, 0 ]]
  ]
};
  ...
  XY: [
    [ new THREE.Mesh( new THREE.BoxGeometry( 0.2, 0.2, 0.01 ), matInvisible ), [ 0.2, 0.2, 0 ]]
  ],
  YZ: [
    [ new THREE.Mesh( new THREE.BoxGeometry( 0.2, 0.2, 0.01 ), matInvisible ), [ 0, 0.2, 0.2 ], [ 0, Math.PI / 2, 0 ]]
  ],
  XZ: [
  ...
  DELTA: [
    [ new THREE.Line( TranslateHelperGeometry(), matHelper ), null, null, null, 'helper' ]
			...
			const gizmoRotate = {
				...
				E: [[ new THREE.Mesh( CircleGeometry( 0.6, 1 ), matYellowTransparent ), null, [ 0, Math.PI / 2, 0 ]]]
			};
			const helperRotate = {
			...
			const pickerRotate = {
				...
				E: [[ new THREE.Mesh( new THREE.TorusGeometry( 0.6, 0.1, 2, 24 ), matInvisible ) ]]
			};
  ...
  X: [
    ...
    [ new THREE.Mesh( lineGeometry2, matRed ), [ 0, 0, 0 ], [ 0, 0, - Math.PI / 2 ]]
    // Eliminado el handle de escala negativo en X
  ],
  Y: [
    [ new THREE.Mesh( scaleHandleGeometry, matGreen ), [ 0, 0.5, 0 ]],
    [ new THREE.Mesh( lineGeometry2, matGreen ) ]
    // Eliminado el handle de escala negativo en Y
  ],
  Z: [
    [ new THREE.Mesh( scaleHandleGeometry, matBlue ), [ 0, 0, 0.5 ], [ Math.PI / 2, 0, 0 ]],
    [ new THREE.Mesh( lineGeometry2, matBlue ), [ 0, 0, 0 ], [ Math.PI / 2, 0, 0 ]]
    // Eliminado el handle de escala negativo en Z
  ],
  XY: [
    [ new THREE.Mesh( new THREE.BoxGeometry( 0.15, 0.15, 0.01 ), matBlueTransparent ), [ 0.2, 0.2, 0 ]]
  ],
  YZ: [
    [ new THREE.Mesh( new THREE.BoxGeometry( 0.15, 0.15, 0.01 ), matRedTransparent ), [ 0, 0.2, 0.2 ], [ 0, Math.PI / 2, 0 ]]
  ],
  XZ: [
    [ new THREE.Mesh( new THREE.BoxGeometry( 0.15, 0.15, 0.01 ), matGreenTransparent ), [ 0.2, 0, 0.2 ], [ - Math.PI / 2, 0, 0 ]]
  ],
  XYZ: [
    [ new THREE.Mesh( new THREE.BoxGeometry( 0.1, 0.1, 0.1 ), matInvisible.clone() ) ]
  ]
};
			const pickerScale = {
  X: [
    [ new THREE.Mesh( new THREE.CylinderGeometry( 0.2, 0, 0.6, 4 ), matInvisible ), [ 0.3, 0, 0 ], [ 0, 0, - Math.PI / 2 ]]
    // Eliminado el picker negativo en X
  ],
  Y: [
    [ new THREE.Mesh( new THREE.CylinderGeometry( 0.2, 0, 0.6, 4 ), matInvisible ), [ 0, 0.3, 0 ]]
    // Eliminado el picker negativo en Y
  ],
  Z: [
    [ new THREE.Mesh( new THREE.CylinderGeometry( 0.2, 0, 0.6, 4 ), matInvisible ), [ 0, 0, 0.3 ], [ Math.PI / 2, 0, 0 ]]
    // Eliminado el picker negativo en Z
  ],
  XY: [
  ...
  XYZ: [
    [ new THREE.Mesh( new THREE.BoxGeometry( 0.2, 0.2, 0.2 ), matInvisible ), [ 0, 0, 0 ]]
			...
			const helperScale = {
  X: [
    [ new THREE.Line( lineGeometry, matHelper.clone() ), [ 0, 0, 0 ], null, [ 1e6, 1, 1 ], 'helper' ]
    // Cambiado para que la línea comience desde el origen
  ],
  Y: [
    [ new THREE.Line( lineGeometry, matHelper.clone() ), [ 0, 0, 0 ], [ 0, 0, Math.PI / 2 ], [ 1e6, 1, 1 ], 'helper' ]
    // Cambiado para que la línea comience desde el origen
  ],
  Z: [
    [ new THREE.Line( lineGeometry, matHelper.clone() ), [ 0, 0, 0 ], [ 0, - Math.PI / 2, 0 ], [ 1e6, 1, 1 ], 'helper' ]
    // Cambiado para que la línea comience desde el origen
  ]
};
